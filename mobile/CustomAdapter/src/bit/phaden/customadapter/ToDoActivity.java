...
public class ToDoActivity extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		// Make custom adapter
		ToDoArrayAdapter adapter = new ToDoArrayAdapter(this, R.layout.custom_list_view, toDoArray);
		// Get a reference to the ListView with id lvToDo
		ListView lvItems = (ListView) findViewById(R.id.lvToDo);
...
// Custom adapter to return layout with an ImageView and a TextView
 public class ToDoArrayAdapter extends ArrayAdapter<ToDo>
 {
	...
	public View getView(int position, View convertView, ViewGroup container) 
	{
		...
		ImageView itemImageView = (ImageView) customView.findViewById(R.id.ivThumbnail);
		TextView itemTextView = (TextView) customView.findViewById(R.id.tvDescription);
		...
		itemImageView.setImageDrawable(currentItem.toDoImage);
